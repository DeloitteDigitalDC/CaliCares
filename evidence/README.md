...
|2.j.|Deployed the prototype on an IaaS or PaaS and indicated which provider used|We used Amazon Web Services (AWS) for IaaS. [View here][devops]|
|2.k.|Developed automated unit tests for their code|We embedded our tests in the code repository and executed them with our build process. [View here][scripts]
